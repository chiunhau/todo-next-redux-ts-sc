import { ADD_TODO, CHECK_TODO, DELETE_TODO, Todo, TodoListState, TodoActionTypes } from './types';
...
const reducer = (state = initialState, action: TodoActionTypes): TodoListState => {
  switch (action.type) {
    case ADD_TODO:
      return {
        ...state,
